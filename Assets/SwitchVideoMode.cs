...
//https://blog.unity.com/technology/codesnippets-toggle-vives-front-facing-camera-and-tron-mode-at-run-time
public class SwitchVideoMode : MonoBehaviour
{
  ...
  public SteamVR_TestTrackedCamera trackedCamera;
  ...
  void Update()
  {
    ...
    if (Input.GetKeyDown(KeyCode.Alpha2))
      vMode = VideoMode.TRON;
    if (Input.GetKeyDown(KeyCode.Alpha3))
      vMode = VideoMode.VIDEO;
    if (Input.GetKeyDown(KeyCode.Alpha4))
      vMode = VideoMode.TRON_AND_VIDEO;
